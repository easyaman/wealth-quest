...
## บอทก็ยิงสัญญาณนี้เหมือนกัน (ไม่มีการเช็ก `is_ai` ในนี้เลย เหมือน `changed`) — ฝั่งที่ต่อสาย
## ฟังต้องกรองเอาเฉพาะผู้เล่นคนจริงเอง ไม่งั้นเสียงจะถี่รัวจากบอททุกตัวที่กระทำพร้อมกันทุกเดือน
