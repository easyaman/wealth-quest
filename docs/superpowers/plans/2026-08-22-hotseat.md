...
```gdscript
	# --- ม่านส่งเครื่อง ---
	# ตาแรกไม่ต้องมีม่าน คนที่เปิดเกมคือคนที่นั่งอยู่หน้าจอแล้ว
	_eq("ตาแรกยังไม่ต้องมีม่าน", main2.pass_screen == null, true)
...
3. เข้าเกม — แผงอันดับต้องมีสี่ชื่อ คนจริงสอง บอทสอง
