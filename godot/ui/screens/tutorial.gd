...
func _build_steps() -> Array:
	...
	return [
		...
		{"m": 4, "target": "travel", "t": "ป้องกันถูกกว่ารักษาเสมอ",
		"x": "แผงนี้บอกว่าที่ไหนทำอะไรได้และกินเวลาเท่าไหร่ — [b]ฟิตเนส[/b] เพิ่มสุขภาพ · "
			+ "[b]รีสอร์ต[/b] ลดโอกาสเกิดเรื่องร้ายในเดือนนั้น\n\n"
			+ "เทียบกับค่ารักษาตอนล้มป่วยที่แพงกว่ารายจ่ายทั้งเดือน 1–3 เท่า บวกเสียเวลาอีก 90 ชม."},

		{"m": 5, "target": "deals", "t": "กับดักสำคัญที่สุดของเกมนี้",
